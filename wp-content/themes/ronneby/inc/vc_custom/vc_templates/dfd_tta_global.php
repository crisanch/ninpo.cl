...
$dfd_tab_style = '';
	if(isset($border_radius) && $border_radius != '') {
		$dfd_tab_style .= $id.'.dfd_tabs_block .vc_tta-tabs .vc_tta-tabs-container .vc_tta-tabs-list li.vc_tta-tab a, '.$id.'.dfd_tabs_block .dfd_tta_tabs .vc_tta-panels-container .vc_tta-panels .vc_tta-panel-heading a {border-radius: '.$border_radius.';}';
