							...
							$output .= '<div class="text-wrap">';
								$output .= '<div class="dfd-price-cover clearfix">';
									...
									if(isset($fields['price']) && !empty($fields['price'])){
										$output .= '<'.esc_attr($title_font_options['tag']).' class="amount-price amount '.esc_attr($title_font_options['class']).'" style="'.$title_font_options['style'].'"> ' . esc_html($fields['price']) . ' </'.esc_attr($title_font_options['tag']).'>';
									}
								$output .= '</div>';
