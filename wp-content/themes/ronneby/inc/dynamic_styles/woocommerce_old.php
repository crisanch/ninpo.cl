...
$output .= '.single-product p.stock {';
	...
	$output .= 'color: '. Dfd_Theme_Helpers::dfd_hex2rgb($vars['title_color'], .7) .';';
$output .= '}';
$output .= '.single-product .description {';
...
$output .= '.product-ordering {';
	$output .= 'font-family: '. $vars['text_font-family'] .';';
$output .= '}';
$output .= '.product-ordering .dropdown .dropdown-toggle span.title {';
	$output .= 'font-size: '. ((int)$vars['text_font-size'] - 1) .'px;';
	$output .= 'color: '. $vars['title_color'] .';';
$output .= '}';
$output .= '.product-ordering .dropdown .dropdown-toggle span.arrows:before {';
	$output .= 'color: '. $vars['title_color'] .';';
$output .= '}';
$output .= '.product-ordering .dropdown .dropdown-menu li a {';
	$output .= 'font-size: '. $vars['text_font-size'] .';';
	$output .= 'color: '. $vars['title_color'] .';';
$output .= '}';
