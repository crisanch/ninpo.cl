...
//        $message = htmlspecialchars($message);
		$arr = array_merge(array(
			...
			array(
				'type' => 'number',
				'heading' => '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">' . esc_html__('This option allows you to define the height of the text area', 'dfd-native') . '</span></span>' . __('Textarea height (Number of visible paragraphs)', 'dfd'),
