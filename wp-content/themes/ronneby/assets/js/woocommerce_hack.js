...
(function($){
	...
	$('body').on('show_variation reset_image', function() {
		var $linkLarge = $('.woocommerce.single-product .woocommerce-main-image > a'),
			$largeSrc = $linkLarge.attr('href'),
			wooHoverLargeImg = function() {
				$linkLarge.find('.dfd-large-image').attr('src', $largeSrc);
			};
		wooHoverLargeImg();
	});
